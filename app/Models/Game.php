...
class Game extends Model
{
    ...
    {
        return $this->belongsToMany(User::class, 'game_players', 'game_id', 'user_id', 'id', 'id')
            ->withPivot('result', 'color', 'player_participation_validation', 'player_result_validation');
    }
