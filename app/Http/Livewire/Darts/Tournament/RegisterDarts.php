...
class RegisterDarts extends ModalComponent
{
    use HasToast;
    ...
    public function register()
    {
        ...
        $this->closeModalWithEvents([ListTournamentDarts::getName() => ['refreshListTournament', []]]);
    }

    public function render()
    {
        return view('livewire.darts.tournament.register-darts');
    }
}
