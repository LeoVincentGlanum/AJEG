...
<div>
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 h-screen transition-transform -translate-x-full 2xl:translate-x-0" aria-label="Sidebar">
                    ...
                    <ul role="list" class="mt-[86px] space-y-[18px]">
                        ...
                        <li>
                            <x-nav-link
                                ...
                                id="bets-link"
                            >
                                <svg class="w-5 h-5" enable-background="new 0 0 24 24" height="512" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg"><ellipse cx="7" cy="2" rx="7" ry="2"/><path d="m7 8.5c3.866 0 7-.895 7-2v-2.267c-2.204 1.181-5.996 1.267-7 1.267s-4.796-.086-7-1.267v2.267c0 1.105 3.134 2 7 2z"/><path d="m9.5 18.87v2.99c-.77.09-1.62.14-2.5.14-3.87 0-7-.9-7-2v-2.27c2.2 1.18 6 1.27 7 1.27.43 0 1.38-.02 2.5-.13z"/><path d="m9.61 14.36c-.03.09-.05.2-.07.3l-.04-.03v2.73c-.77.09-1.62.14-2.5.14-3.87 0-7-.9-7-2v-2.27c2.2 1.18 6 1.27 7 1.27.44 0 1.44-.02 2.61-.14z"/><path d="m7 10c-1.004 0-4.796-.086-7-1.267v2.267c0 1.105 3.134 2 7 2s7-.895 7-2v-2.267c-2.204 1.181-5.996 1.267-7 1.267z"/><ellipse cx="17.5" cy="15" rx="6.5" ry="2"/><path d="m17.5 20.5c3.59 0 6.5-.895 6.5-2v-1.267c-2.046 1.182-5.568 1.267-6.5 1.267s-4.454-.086-6.5-1.267v1.267c0 1.105 2.91 2 6.5 2z"/><path d="m17.5 22c-.932 0-4.454-.086-6.5-1.267v1.267c0 1.105 2.91 2 6.5 2s6.5-.895 6.5-2v-1.267c-2.046 1.181-5.568 1.267-6.5 1.267z"/></svg>
                            </x-nav-link>
                        </li>
                    </ul>
                </li>
                ...
                <li class="align-self-end">
                    <ul role="list" class="mt-2 space-y-[18px]">
                        <li>
                            ...
                            >
                                <svg class="w-5 h-5" height="512" viewBox="0 0 48 48" width="512" xmlns="http://www.w3.org/2000/svg"><g id="Line"><path d="m24 2a15 15 0 0 0 -15 15v11.7l-3.32 5a4.08 4.08 0 0 0 3.39 6.3h29.86a4.08 4.08 0 0 0 3.39-6.33l-3.32-4.97v-11.7a15 15 0 0 0 -15-15z"/><path d="m24 46a6 6 0 0 0 5.65-4h-11.3a6 6 0 0 0 5.65 4z"/></g></svg>
                            </x-nav-link>
                        </li>
                        <li>
                            <x-nav-link
