    ...
    @if($gameType !== null)
            ...
            <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 class="font-custom-title text-lg leading-6 font-medium text-gray-900" id="modal-title">
                        Supprimer la catégorie "{{ $gameType->label }}"
                    </h3>
                    <div class="mt-2">
                        <p class="text-sm text-gray-500">
                            Êtes-vous sûr de vouloir supprimer cette catégorie ? Cette action est irréversible et ne pourra pas être annulée.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <form wire:submit.prevent="delete">
                <button
                    type="submit"
                    class="px-4 py-2 text-sm inline-flex items-center border border-transparent font-medium rounded-md shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 bg-primary"
