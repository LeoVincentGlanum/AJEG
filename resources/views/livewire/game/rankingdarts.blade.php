                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $user->elo_darts }}</td>
                                    <td class="text-center">@if((int)$user->elo_darts > 2000 && (int)$user->elo_darts < 2500)
                                            <span
                                        ...
                                        @elseif((int)$user->elo_darts > 1750 && (int)$user->elo_darts < 2000)
                                            <span
                                                class="h-8 w-8 rounded-full bg-gray-400 flex items-center justify-center ring-8 ring-white">
                                                                                              <img
                                        ...
                                        @elseif((int)$user->elo_darts > 1500 && (int)$user->elo_darts < 1750)
                                            <span
                                                class="h-8 w-8 rounded-full bg-gray-400 flex items-center justify-center ring-8 ring-white">
                                                                                              <img src="/img/diams.png"
                                                                                                   style="max-width: 150%">
                                                                                            </span>
                                        @elseif((int)$user->elo_darts > 1200 && (int)$user->elo_darts < 1500)
                                            <span
                                                class="h-8 w-8 rounded-full bg-gray-400 flex items-center justify-center ring-8 ring-white">
                                                                                            <img src="/img/rubis.png"
                                                                                                 style="max-width: 150%">
                                                                                        </span>
                                        @elseif((int)$user->elo_darts > 800 && (int)$user->elo_darts < 1200)
                                            <span
                                                class="h-8 w-8 rounded-full bg-gray-400 flex items-center justify-center ring-8 ring-white">
