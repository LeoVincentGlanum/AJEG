            ...
            <div class="overflow-hidden rounded-md border border-gray-300 bg-white">
                <ul role="list" class="divide-y divide-gray-300">
                    <li class="px-6 py-4">
                        <div>
                            ...
                            <div class="flex justify-between">
                                ...
                                <a wire:click="$emit('openModal', 'notifications.delete-game-request',{{ json_encode(["game" => $game->id]) }})" class="inline-flex items-center rounded-full border border-transparent bg-indigo-600 p-3 text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                    ...
                    @if($game->status == "playersvalidation" && $CurrentUserGame->player_participation_validation== "pending")
                            ...
                            <li class="px-6 py-4">
                                <a wire:click="acceptInvitation" class="inline-flex items-center rounded-md border border-transparent bg-green-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                    {{ __('Accept') }}
                                    <x-heroicon-o-check class="ml-5 w-5" />
                                </a>
                                <a wire:click="refuseInvitation" class="inline-flex items-center rounded-md border border-transparent bg-red-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                    {{ __('Refuse') }}
