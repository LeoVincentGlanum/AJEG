            ...
            <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                ...
                <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                    <form wire:submit.prevent="savePicture" class="flex items-center space-x-6">
                        <div class="shrink-0">
                            <img class="h-16 w-16 object-cover rounded-full" src="{{ asset('/img_profil/'.Auth::user()->photo) }}"  onerror="this.onerror=null; this.src='/img/user-default.png'" alt="Photo de profil de {{$user->name}}" />
                        </div>
                        <label class="block">
