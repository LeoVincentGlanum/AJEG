    ...
    <div class="mt-3">
        ...
        <form wire:submit.prevent="submit">
            ...
            <div class="mt-5">
                ...
                <input type="email" wire:model="partyName" class="form-control" id="exampleInputEmail1"
            ...
            @foreach($users as $user)
                <div class="form-check">
                    <input wire:model="players" value="{{$user->id}}" class="form-check-input" type="checkbox"
            ...
            ">
                    <button type="submit" class="btn btn-success mt-3" style="margin-left: 1vw;">Creer la partie
                    </button>
                    @else
                        <div class="alert alert-danger mt-3" role="alert">
                            <strong>Attention ! </strong> Vous devez renseingner aux moins deux joueurs avant de passer
                            à la suite
                        </div>
            @endif
