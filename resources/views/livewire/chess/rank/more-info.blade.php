<div class="grid grid-cols-2 gap-80 justify-content-between">
    <div>
        ...
        <div class="flex items-center h-12 w-96 rounded-lg" style="background-color: white">
            ...
            <img class="h-9 w-9 rounded-full ml-3" src="{{ asset('img_profil/'.$info_best_player->photo) }}" alt="">
    ...
    <div >
        ...
        <div class="flex items-center h-12 w-96 rounded-lg" style="background-color: white">
            ...
            <img class="h-9 w-9 rounded-full ml-3" src="{{ asset('img_profil/'.$info_best_player->photo) }}" alt="">
            <p class="ml-3 whitespace-nowrap font-semibold">{{ $info_best_bet ? $info_best_bet->name : '' }}</p>
            <p class="ml-28 mr-1 whitespace-nowrap font-semibold start-right">{{  $info_best_bet ? $info_best_bet->wins : '' }} paris réussis </p>
        </div>
    </div>
</div>
