                                ...
                                <div class="flex items-center px-4 py-4 sm:px-6">
                                    <div class="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
                                        ...
                                        <div class="mt-4 flex sm:mt-0 sm:ml-5">
                                             <button onclick="return false;" wire:click="$emit('openModal', 'chess.game.delete-draft-chess' , {{$data}})" type="button"  class="mr-[50px] inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-3 py-2 text-sm font-medium leading-4 text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
