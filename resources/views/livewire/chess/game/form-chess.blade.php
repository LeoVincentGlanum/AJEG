        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form wire:submit.prevent="save" class="space-y-8 divide-y divide-gray-200">
                    <div class="space-y-8">
                        <div>
                            <label for="partyName" class="text-lg font-medium leading-6 text-gray-900">Nom de la partie</label>
                            <input
                                id="partyName"
                                type="text"
                        ...
                        <div class="mt-5">
                            <div class="grid grid-cols-3">
                                <div class="col-span-3 sm:col-span-2">
                                    <label for="first-player-id"></label>
                                    ...
                                    <label for="first-player-color"></label>
                        ...
                        @if($status === \App\ModelStates\GameStates\ResultValidations::class)
                            ...
                            <div class="mt-5">
                                <div class="grid grid-cols-3">
                                    <div class="col-span-3 sm:col-span-2">
                                        <span>player 1</span>
                                        <select id="first-player-color" wire:model="players.0.result" class="form-control">
                                    ...
                                    <div class="mt-3 col-span-3 sm:col-span-2">
                                        <span>player 2</span>
                                        <select id="second-player-color" wire:model="players.1.result" class="form-control">
                                            @foreach(\App\ModelStates\GamePlayerResultState::gameFinishedResults() as $class => $name)
                                                <option value="{{ $class }}">{{ $name }}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="mt-6 flex items-center">
                            ...
                            <button type="button" wire:click="saveDraft" class="inline-flex items-center rounded-md border border-transparent bg-orange-100 px-4 py-2 ml-3 text-sm font-medium text-indigo-700 hover:bg-orange-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                {{ __('Save draft') }}
                            </button>
