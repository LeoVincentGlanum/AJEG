                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="flex justify-end">
                                    <button
                                        ...
                                        wire:click="$emit('openModal', 'darts.notifications.bet-game-darts',{{ json_encode(["game" => $game->id]) }})"
                                    ...
                                    <a wire:click="$emit('openModal', 'darts.notifications.delete-game-request-darts',{{ json_encode(["game" => $game->id]) }})"
