            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between">
                    ...
                    <a
                        ...
                        wire:click="$emit('openModal', 'darts.tournament.form-darts')"
                    >
                        {{ __('Créer un tournoi') }}
                    </a>
                </div>
                                        ...
                                        @forelse($tournaments as $tournament)
                                            ...
                                            >
                                                ...
                                                @if($tournament->organizer_id === \Illuminate\Support\Facades\Auth::id())
                                                    <td class="px-4 py-2 text-xs whitespace-nowrap text-center">
                                                        <a href="{{ route('darts.tournament.edit-darts', ['tournament' => $tournament->id]) }}"
                                                           target="_blank">
                                                            <x-heroicon-s-pencil
                                                ...
                                                <td class="px-4 py-2 text-xs whitespace-nowrap text-center">
                                                    ...
                                                    @endphp
                                                    <a wire:click="$emit('openModal', 'darts.tournament.register-darts', {{ $data }})">
                                                        <x-heroicon-s-ticket
